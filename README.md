...
Bu depo, **Spectra** uygulamasının otomatik güncelleme sistemi için kullanılmaktadır.

Burada bulunan dosyalar:

- Stable güncelleme bilgileri
- Beta güncelleme bilgileri
- Sürüm notları
...
- `update-beta.json` → Beta sürüm bilgileri
...
Spectra uygulaması açıldığında otomatik olarak bu depoyu kontrol eder.
...
© Spectra Labs
![Akıllı Öneriler](images/oneriler.png)
